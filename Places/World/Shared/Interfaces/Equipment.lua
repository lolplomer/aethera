...
local WindowManager = require(ReplicatedStorage.Utilities.GUI.WindowManager)
...
local Util = ReplicatedStorage.Utilities.GUI
            ...
            :split({0.4,0.6}, function(Title, TypeEquips)
                ...
                :addElement(function()
                    ...
                    if playerData then
                        ...
                        local InvData = playerData.Inventory
                        ...
                        local function Callback(Type, Subtype_or_Pos)
                            return function(_, inputObject)
                                GUI:CreatePopup('EquipPopup', GUI.newElement('ButtonList', {
                                    Buttons = {
