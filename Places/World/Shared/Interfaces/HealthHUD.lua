...
function HUD:GetExpMinMax()
    ...
    local DataReplica = PlayerDataController.PlayerData
...
function HUD:didMount()
    ...
    task.defer(function()
        local DataReplica = PlayerDataController:GetPlayerData()
