...
local NormalPopup = require(ReplicatedStorage.Utilities.GUI.Popup.Normal)
local roact = require(ReplicatedStorage.Utilities.Roact)
local story = require(script.Parent.Parent.RoactStory)
...
return story(function()
    return createElement(NormalPopup, {
        Ratio = 1.3,
